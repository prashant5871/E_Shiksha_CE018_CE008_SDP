...
//       <div className="w-full  p-4 bg-gray-400 border border-gray-400  shadow-sm sm:p-6">
//         <h5 className="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
//           Connect wallet
//         </h5>
//         <p className="text-sm font-normal text-gray-500 dark:text-white">Connect with one of our available wallet providers or create a new one.</p>
